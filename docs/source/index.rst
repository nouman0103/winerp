...
- Requesting data from another client:
   ...
   .. code-block:: python3
      ...
      user_name = await ipc_client.request(
         route="fetch_user_name",
         source="another-cool-bot",
         user_id = 123
      )
...
~~~~~~~~~~~~~~~~
   ...
   - Join our `Discord`_ server for support.
   - Report bugs and feature requests at `GitHub`_

.. _Discord: https://discord.gg/SpMGPkjwyT
.. _GitHub: https://www.github.com/BlackThunder01001/winerp
